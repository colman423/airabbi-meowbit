...
(function (pxtblockly) {
    ...
    var FieldAnimationEditor = /** @class */ (function (_super) {
        ...
        FieldAnimationEditor.prototype.createNewAsset = function (text) {
            var project = pxt.react.getTilemapProject();
            if (text) {
                var match = /^\s*assets\s*\.\s*animation\s*`([^`]+)`\s*$/.exec(text);
                if (match) {
                    var asset_1 = project.lookupAssetByName("animation" /* Animation */, match[1].trim());
                    if (asset_1)
                        return asset_1;
                }
...
(function (pxtblockly) {
    var FieldSpriteEditor = /** @class */ (function (_super) {
        ...
        FieldSpriteEditor.prototype.createNewAsset = function (text) {
            var project = pxt.react.getTilemapProject();
            if (text) {
                var match = /^\s*assets\s*\.\s*image\s*`([^`]+)`\s*$/.exec(text);
                if (match) {
                    var asset = project.lookupAssetByName("image" /* Image */, match[1].trim());
                    if (asset)
                        return asset;
        ...
        FieldSpriteEditor.prototype.getValueText = function () {
            if (this.asset && !this.isTemporaryAsset())
                return "assets.image`" + (this.asset.meta.displayName || this.asset.id.substr(this.asset.id.lastIndexOf(".") + 1)) + "`";
    ...
    var FieldTilemap = /** @class */ (function (_super) {
        ...
        FieldTilemap.prototype.createNewAsset = function (newText) {
            ...
            if (match) {
                ...
                var resolved = project.lookupAssetByName("tilemap" /* Tilemap */, tilemapId);
                if (!resolved) {
                    resolved = project.lookupAsset("tilemap" /* Tilemap */, tilemapId);
                }
                if (resolved) {
                    return resolved;
                }
    ...
    var FieldTileset = /** @class */ (function (_super) {
        ...
        FieldTileset.prototype.doValueUpdate_ = function (newValue) {
            ...
            if (newValue) {
                ...
                var match = /^\s*assets\s*\.\s*tile\s*`([^`]+)`\s*$/.exec(newValue);
                if (match) {
                    newValue = match[1];
                }
